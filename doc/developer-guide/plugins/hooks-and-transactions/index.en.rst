...
.. graphviz::
   ...
   digraph http_txn_state_diagram{
     ...
     "pick address" -> "TS_CONNECTION_IP_CATEGORY_HOOK outbound";
     "TS_CONNECTION_IP_CATEGORY_HOOK outbound" -> "try connect" [label = "       "];
     ...
     "TS_CONNECTION_IP_CATEGORY_HOOK inbound" [shape = box];
     "TS_CONNECTION_IP_CATEGORY_HOOK outbound" [shape = box];
