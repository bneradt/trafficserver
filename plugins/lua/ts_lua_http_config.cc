...
typedef enum {
  ...
  TS_LUA_CONFIG_HTTP_DROP_CHUNKED_TRAILERS                    = TS_CONFIG_HTTP_DROP_CHUNKED_TRAILERS,
  ...
  TS_LUA_CONFIG_HTTP_CACHE_DEFER_WRITE_ON_MISS                = TS_CONFIG_HTTP_CACHE_DEFER_WRITE_ON_MISS,
...
ts_lua_var_item ts_lua_http_config_vars[] = {
  ...
  TS_LUA_MAKE_VAR_ITEM(TS_LUA_CONFIG_SSL_CLIENT_VERIFY_SERVER_POLICY),
  TS_LUA_MAKE_VAR_ITEM(TS_LUA_CONFIG_SSL_CLIENT_VERIFY_SERVER_PROPERTIES),
  TS_LUA_MAKE_VAR_ITEM(TS_LUA_CONFIG_SSL_CLIENT_SNI_POLICY),
  TS_LUA_MAKE_VAR_ITEM(TS_LUA_CONFIG_SSL_CLIENT_PRIVATE_KEY_FILENAME),
  TS_LUA_MAKE_VAR_ITEM(TS_LUA_CONFIG_SSL_CLIENT_CA_CERT_FILENAME),
  TS_LUA_MAKE_VAR_ITEM(TS_LUA_CONFIG_SSL_CLIENT_ALPN_PROTOCOLS),
  TS_LUA_MAKE_VAR_ITEM(TS_LUA_CONFIG_HTTP_HOST_RESOLUTION_PREFERENCE),
  TS_LUA_MAKE_VAR_ITEM(TS_LUA_CONFIG_HTTP_SERVER_MIN_KEEP_ALIVE_CONNS),
  ...
  TS_LUA_MAKE_VAR_ITEM(TS_LUA_CONFIG_HTTP_CACHE_DEFER_WRITE_ON_MISS),
