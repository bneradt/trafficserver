...
config_path = os.path.join(Test.TestDirectory, "configs/notexistsconfig.txt")
...
server.Streams.All = "gold/doesntexistcookie.gold"
...
server2.Streams.All = "gold/existscookie.gold"
