...
config_path = os.path.join(Test.TestDirectory, "configs/existsconfig.txt")
...
server.Streams.All = "gold/existscookie.gold"
...
server2.Streams.All = "gold/doesntexistcookie.gold"
